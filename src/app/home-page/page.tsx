...
const page = () => {
    ...
    return (
        <div className="w-full">
            <div className="sm:flex justify-center items-center sm:pt-24 pt-16 text-justify sm:px-44 sm:pb-[100px] pb-12">
                ...
                <div className="sm:w-1/2 font-poppin">
                    ...
                    <div className="sm:flex justify-center items-center sm:pt-10 sm:gap-14 grid gap-y-4">
